...
class FileReader
{
    public:
        ...
        string read();
        /*!< Returns a string containing the contents of a text file. Reads all the contents of the text file. */
        void write(const string& input);
        /*!< Takes a constant reference to a string and writes its data to a text file. */
