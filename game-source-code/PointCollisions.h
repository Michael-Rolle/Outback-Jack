...
class PointCollisions
{
    public:
        ...
        Checks for a collision occuring. Takes in the respective Player, a FishController to access the respective fish,
        a Score object to update the players' score and a GameSounds object to play a sound when the player collides with a
        fish. Parameters do not allow for the collision detection of multiple players  */
