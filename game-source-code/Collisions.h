...
killing the player. The player can earn points for landing on platforms and the platforms only change colour if the tent is not built. The player moves with the platform if they stand still on
it. A sound is played when the player lands on a platform. Also checks if the player is within the safe zone.
*/
