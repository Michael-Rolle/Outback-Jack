...
class GameManager
{
    public:
        GameManager();
        void run(); /*!< Takes in no parameters and doesn't return a type. Responsible for executing private member
                    functions while the window is open. Hence updating the game as events take place. */
    private:
        void pollEvent();
        void update();
        void render();
